...
namespace UnityPhysics2DPlugin
{
    ...
    internal static class MathHelper
    {
        ...
        [BurstCompile]
        static void ToQuaternionCore(float yaw, float pitch, float roll, out quaternion result)
        {
            yaw *= Mathf.Deg2Rad;
            pitch *= Mathf.Deg2Rad;
            roll *= Mathf.Deg2Rad;
        ...
        [BurstCompile]
        static void ToEulerAnglesCore(ref quaternion quaternion, out float3 result)
        {
